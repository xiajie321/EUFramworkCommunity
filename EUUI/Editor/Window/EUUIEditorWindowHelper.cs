...
namespace EUFramework.Extension.EUUI.Editor
{
    ...
    internal static class EUUIEditorWindowHelper
    {
        ...
        {
            const string fallback = "Assets/EUFramework/Extension/EUUI/Editor/Window/UIToolKit";
            ...
            foreach (string guid in guids)
            {
                ...
                if (Path.GetFileName(path) == "EUUIEditorWindow.cs")
                {
                    scriptPath = path;
                    break;
                }
            ...
            return Path.Combine(scriptDir, "UIToolKit").Replace("\\", "/");
        }
