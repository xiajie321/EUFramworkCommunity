...
namespace EUFramework.Extension.EUUI.Editor
{
    ...
    public class EUUIExtensionTemplateCreator : EditorWindow
    {
        ...
        {
            string templateText = templatePreset switch
            {
            ...
            scriptObject["extension_name"] = extensionName;
            scriptObject["creation_time"]  = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            scriptObject["extension_type"] = extensionType.ToString();
